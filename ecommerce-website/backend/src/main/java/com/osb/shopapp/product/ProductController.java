...
public class ProductController {
    ...
    public ResponseEntity<PageResponse<ProductResponse>> findAllExceptSellerProducts(
        ...
        PageResponse<ProductResponse> foundProducts = (search == null || search.isBlank()) ?
                ...
                : productService.findAllByExceptSellerProductByKeyword(pageNumber, pageSize, sortBy, sortDirection, search, authentication);
        return new ResponseEntity<>(foundProducts, HttpStatus.OK);
    }
    ...
    public ResponseEntity<byte[]> findPriamryProductImage(
            @PathVariable("product-id") Integer productId
    ) {
    ...
    public ResponseEntity<?> updatedProductAvailability(
            @PathVariable(name = "product-id") Integer productId,
            @Valid @RequestBody ProductAvailableRequest productAvailableRequest
    ) {
        productService.updateAvailability(productId, productAvailableRequest.getIsDeleted());
